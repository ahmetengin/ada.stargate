...
**Scope:** Frontend (React/Gemini), Backend (Python/LangGraph).
...
## 3. THE HYPERSCALE BRAIN (Python Backend)
...
### 3.2. The MAKER Node (Large Language Models as Tool Makers)
**Prompt:**
...
### 3.3. The SEAL Node (Self-Adapting Language Models)
...
### 4.2. Finance Expert (`financeAgent.ts`)
...
### 4.3. Legal Expert (`legalAgent.ts`)
...
### 4.4. Security Expert (`securityAgent.ts`)
...
## 5. DOCUMENT INGESTION (RAG MEMORY)
